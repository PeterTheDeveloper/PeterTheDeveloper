...
USER_NAME = os.environ['USER_NAME'] # 'PeterTheDeveloper'
...
if __name__ == '__main__':
    ...
    # Peter's birthday: January 16, 1997
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(1997, 1, 16))
